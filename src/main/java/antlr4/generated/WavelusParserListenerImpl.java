...
//        finalCode.append(ctx.getText());
    ...
    public void enterAssignment(WavelusParser.AssignmentContext ctx) {
        ...
        finalCode.append(ctx.IDENTIFIER().getText());
        finalCode.append("=");
    }
    ...
    public void enterFunctionCall(WavelusParser.FunctionCallContext ctx) {
        ...
        if (ctx.PRINT()!=null){
            ...
            finalCode.append(ctx.OPEN_PAREN().getSymbol().getText());
        }
    ...
    public void exitFunctionCall(WavelusParser.FunctionCallContext ctx) {
        ...
        if (ctx.PRINT()!=null){
            finalCode.append(ctx.CLOSE_PAREN().getSymbol().getText());
        }
    }
    ...
    public void enterIfStat(WavelusParser.IfStatContext ctx) {
        ...
        finalCode.append("if (");
        finalCode.append(ctx.booleanExpression().getText());
        finalCode.append(")");
    }
    ...
    public void enterExpression(WavelusParser.ExpressionContext ctx) {
        ...
        if (ctx.parent.getRuleIndex()==WavelusParser.RULE_assignment){
            finalCode.append(ctx.getText());
        }
